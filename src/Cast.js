                    ...
                    <div className='Actors'>
                        <ul>
                            <li>
                                 ...
                                 <label className='starActors' for='part'>Indiana Jones</label>
                            </li> <br></br>
                            ...
                            <li>
                                ...
                                <label className='starActors' for='part'>Marion Ravenwood</label>
                            </li> <br></br>

                            <li>
                                <img src="https://flxt.tmsimg.com/assets/83286_v9_ba.jpg" alt="Denholm Elliott" style={{width: 90, height: 100}}/>
                                <label className='starActors' for='part'>Marcus Brody</label>
                            </li> <br></br>
                            ...
                            <li>
                                ...
                                <label className='starActors' for='part'>Toht</label>
                            </li> <br></br>
                        </ul>
                    </div>
